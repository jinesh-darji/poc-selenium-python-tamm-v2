...
from new_business_food_restaurant.pages.LandingPage.RemovePROForm import RemovePROForm
from new_business_food_restaurant.pages.LandingPage.LandingGuidelinePage import LandingGuidePage


class TestCancelButtonAssignPROPage:

    @pytest.mark.smoke
    def test_cancel_button_remove_assign_pro_form(self):
        ...
        with allure.step("Select 'Cancel Request' button"):
            form_field.click_cancel_request_btn()

        """Remove PRO Form"""

        with allure.step("Select 'Cancel' button"):
            remove_pro = RemovePROForm()
            remove_pro.click_cancel_btn()
