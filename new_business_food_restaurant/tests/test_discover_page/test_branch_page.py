...
from new_business_food_restaurant.pages.Discover.DiscoverNeworBranchRestaurantPage import DiscoverNeworBranchRestaurantPage
...
class TestLegalFormsWithEmiratiSoleSoleProprietorshipLLCPage:
    ...
    def test_branch_page(self):
        ...
        with allure.step("Open pop up for area details"):
            browser = Browser()
            browser.set_url("https://nbfr-pretest.digitalx1.io/journeys/new-business-food-restaurant/discover/areas/Al%20Qurm")
        ...
        with allure.step("Select 'UAE Branch' button"):
            ...
            discover_new_branch.click_uae_branch_btn()
