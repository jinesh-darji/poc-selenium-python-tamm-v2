...
class TestLegalFormsWithEmiratiSoleSoleProprietorshipLLCPage:

    @pytest.mark.smoke
    def test_legal_forms_with_emirati_sole_soleproprietorshipllc_page(self):
        ...
        Emirati Page
        """
        with allure.step("Select 'Yes' button of 'Are you an emirati?' page"):
            emirati = EmiratiPage()
            emirati.click_yes_btn()
        ...
        """
        with allure.step("Select 'Sole' button of 'How will the company be formed?' page"):
            sole_partner = DiscoverSoleOrPartnershipPage()
            sole_partner.click_sole_btn()
        ...
        Establishment Page
        """
        with allure.step("Select 'Sole Proprietorship LLC' button of 'You're eligible to establish the following:' page"):
