...
class TestDiscoverActivityWithoutProvideMealAndWithoutDeliverFoodPage:

    """Use can able to open activity page"""

    @pytest.mark.smoke
    def test_discover_activity_without_provide_meal_and_without_deliver_food_page(self):
