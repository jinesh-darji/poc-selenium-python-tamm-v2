...
class TestLegalFormsWithGCCSoleSoleProprietorshipLLCPage:

    @pytest.mark.smoke
    def test_legal_forms_with_gcc_sole_soleproprietorshipllc_page(self):
        ...
        GCC Page
        """
        with allure.step("Select 'Yes' button of 'Are you an GCC?' page"):
            gcc = GCCPage()
            gcc.click_yes_btn()
