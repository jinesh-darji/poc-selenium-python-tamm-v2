...
class TestLegalFormsWithEmiratiSoleEstablishmentPage:

    @pytest.mark.smoke
    def test_legal_forms_with_emirati_sole_establishment_page(self):
        ...
        Establishment Page
        """
        with allure.step("Select 'Establishment' button of 'You're eligible to establish the following:' page"):
