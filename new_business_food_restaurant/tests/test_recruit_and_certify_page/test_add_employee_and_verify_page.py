...
class TestAddEmployeeAndVerifyPage:

    @pytest.mark.smoke
    def test_add_employee_and_verify_page(self):
        ...
        with allure.step("is 'Employee Information' text displayed"):
            employee_tracker.lbl_employee_profile.wait_until_location_stable()
            assert_that(employee_tracker.lbl_employee_profile, "is 'Employee Information' text not displayed")
