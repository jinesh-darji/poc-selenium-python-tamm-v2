...
from new_business_food_restaurant.pages.DesignAndADFCAInspection.AuthorizedContractorsPage import AuthorizedContractorsPage
...
class TestAuthorizedContractorsPage:
    ...
    def test_authorized_contractors_page(self):
        ...
        """Authorized Contractors Page"""

        with allure.step("Select 'Search Contractor' button"):
            contractors = AuthorizedContractorsPage()
            assert_that(contractors.is_displayed_contractors_detail(), "List of Contractors is not displayed")
