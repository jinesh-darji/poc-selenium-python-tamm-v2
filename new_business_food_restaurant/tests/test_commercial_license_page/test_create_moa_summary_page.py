...
from new_business_food_restaurant.pages.CommercialLicense.MOAPage import MOAPage
from new_business_food_restaurant.pages.CommercialLicense.CreateMOAPage import CreateMOAPage
from new_business_food_restaurant.pages.CommercialLicense.AddManagerForm import AddManagerForm
from new_business_food_restaurant.pages.CommercialLicense.MoAAuthorizationPage import MOAAuthorizationPage
from new_business_food_restaurant.pages.CommercialLicense.SummaryDocumentPage import SummaryDocumentPage


class TestCreateMOASuccessPage:

    @pytest.mark.smoke
    def test_create_moa_success_page(self):
        ...
        with allure.step("Select 'LLC' button in 'Establishment' page"):
        ...
        with allure.step("Select 'Create MOA' button"):
            moa = MOAPage()
            moa.click_emoa_btn()

        """Create MOA Page"""

        with allure.step("Fill data in 'Total Capital' text field"):
            create_moa = CreateMOAPage()
            create_moa.fill_total_capital()

        with allure.step("Fill data in 'Annual Revenue' text field"):
            create_moa.fill_annual_revenue()

        with allure.step("Fill data in 'Total Number of Shares' text field"):
            create_moa.fill_total_number_of_shares()

        with allure.step("Select 'Add Manager' button"):
            create_moa.click_add_manager_btn()

        """Add Manager Form"""

        with allure.step("Select 'Title' from the drop down"):
            add_manager = AddManagerForm()
            add_manager.drpdwn_select_title("Mr")

        with allure.step("Fill 'English Name' of manager"):
            add_manager.fill_name_in_english()

        with allure.step("Fill 'Arabic Name' of manager"):
            add_manager.fill_name_in_arabic()

        with allure.step("Fill 'Emirati ID' of manager"):
            add_manager.fill_emirati_id()

        with allure.step("Fill 'Email' of manager"):
            add_manager.fill_email()

        with allure.step("Fill 'Phone Number' of manager"):
            add_manager.fill_phone_number()

        with allure.step("Fill 'Passport Number' of manager"):
            add_manager.fill_passport_number()

        with allure.step("Fill 'POBox' of manager"):
            add_manager.fill_pobox()

        with allure.step("Select 'Year of Number' of manager"):
            add_manager.drpdwn_year_number("3")

        with allure.step("Fill 'Emirates' of manager"):
            add_manager.fill_emirates()

        with allure.step("Fill 'City' of manager"):
            add_manager.fill_city()

        with allure.step("Fill 'Area' of manager"):
            add_manager.fill_area()

        with allure.step("Fill 'Street' of manager"):
            add_manager.fill_street()

        with allure.step("Fill 'Building' of manager"):
            add_manager.fill_building()

        with allure.step("Fill 'Flat' of manager"):
            add_manager.fill_flat()

        with allure.step("Select 'Add Manager' button of manager"):
            add_manager.click_submit_btn()

        """Create MOA Page"""

        with allure.step("Select 'Submit' button"):
            create_moa.click_submit_btn()

        """MoA Authorization Page"""

        with allure.step("Select 'Download MoA' button"):
            auth = MOAAuthorizationPage()
            auth.click_download_moa()

        with allure.step("Select 'Submit'button"):
            auth.click_submit_btn()

        """Download Success Page"""

        with allure.step("Select 'Issue Commercial License' button"):
            summary_document = SummaryDocumentPage()
            summary_document.click_issue_commercial_license()
