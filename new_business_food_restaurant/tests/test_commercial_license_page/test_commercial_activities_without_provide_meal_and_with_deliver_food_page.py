...
class TestCommercialActivitiesWithoutProvideMealAndWithDeliverFoodPage:

    @pytest.mark.smoke
    def test_commercial_activities_without_provide_meal_and_with_deliver_food_page(self):
        ...
        with allure.step("Select 'No' button on 'Provide Meal' page"):
            provide_meal = CommercialLicenseProvideMealPage()
            provide_meal.click_no_btn()
