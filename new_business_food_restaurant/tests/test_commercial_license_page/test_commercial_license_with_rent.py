...
class TestCommercialLicenseWithRentPage:

    @pytest.mark.smoke
    def test_commercial_license_with_rent_page(self):
        ...
        with allure.step("Select 'Yes' radio button"):
            ...
            summary_commercial_license.click_rent_yes_radio()

        with allure.step("Fill 'Tawtheeq Number' in text field"):
            summary_commercial_license.fill_tawtheeq_number()
