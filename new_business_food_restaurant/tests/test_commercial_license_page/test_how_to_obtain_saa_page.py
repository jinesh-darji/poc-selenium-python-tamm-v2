...
from new_business_food_restaurant.pages.CommercialLicense.ServiceAgentAgreementPage import ServiceAgentAgreementPage
from new_business_food_restaurant.pages.CommercialLicense.HowToObtainASAAPage import HowToObtainASAAPage
...
class TestHowToObtainSAAPage:

    @pytest.mark.smoke
    def test_how_to_obtain_saa_page(self):
        ...
        """Service Agent Agreement Page"""

        with allure.step("File Upload"):
            info = ServiceAgentAgreementPage()
            info.click_more_info_btn()

        """How to obtain a service agent agreement?"""

        with allure.step("Verify website text is mentioned"):
            obtain_saa = HowToObtainASAAPage()
            obtain_saa.is_website_is_display()
