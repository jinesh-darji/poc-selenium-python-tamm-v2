...
from new_business_food_restaurant.pages.CommercialLicense.AddPartnerForm import AddPartnerForm


class TestLegalFormEmiratiSoleEstablishmentPage:

    @pytest.mark.smoke
    def test_legal_form_emirati_partner_establishment_page(self):
        ...
        with allure.step("Select 'Partnership' button"):
            sole_partnership_page = CommercialLicenseSoleOrPartnershipPage()
            sole_partnership_page.click_partnership_btn()
        ...
        with allure.step("Select 'Add Partner' button in 'Ownership' page"):
            add_partner = OwnershipDetailsPage()
            add_partner.click_add_partner_btn()

        """Add Partner Details"""

        with allure.step("Add 'English Name' in 'Sponsor' Details"):
            partner_form = AddPartnerForm()
            partner_form.fill_name_in_english()

        with allure.step("Add 'Arabic Name' in 'Sponsor' Details"):
            partner_form.fill_name_in_arabic()

        with allure.step("Add 'DOB' in 'Sponsor' Details"):
            partner_form.set_dob_date()

        with allure.step("Add 'Emirati ID' in 'Sponsor' Details"):
            partner_form.fill_emirati_id()

        with allure.step("Add 'Email' in 'Sponsor' Details"):
            partner_form.fill_email()

        with allure.step("Add 'Phone Number' in 'Sponsor' Details"):
            partner_form.fill_phone_number()

        with allure.step("Add 'Emirati' in 'Sponsor' Details"):
            partner_form.fill_emirates()

        with allure.step("Add 'City' in 'Sponsor' Details"):
            partner_form.fill_city()

        with allure.step("Add 'Area' in 'Sponsor' Details"):
            partner_form.fill_area()

        with allure.step("Add 'Street' in 'Sponsor' Details"):
            partner_form.fill_street()

        with allure.step("Add 'Building' in 'Sponsor' Details"):
            partner_form.fill_building()

        with allure.step("Select 'Submit' in 'Sponsor' Details"):
            partner_form.click_submit_btn()

        """Ownership Page"""

        with allure.step("Select 'Slider %' of partner"):
            add_partner = OwnershipDetailsPage()
            add_partner.click_partner_slider()

        with allure.step("Select 'Next' button"):
            add_partner.click_next_btn()
