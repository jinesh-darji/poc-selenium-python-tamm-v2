...
class DiscoverProvideMealPage(BasePage):
    page_name = "Discover Provide Meal Page"
    locator_reader = LocatorReader(page_name)
    page_element = Label(locator_reader, "discover_provide_meal_locator")
    ...
    def __init__(self):
        super(DiscoverProvideMealPage, self).__init__(self.page_element)
